...
if __name__ == '__main__':
    ...
    model = ResNet()
    net = caffe.Net('./models/ResNet-{}-deploy.prototxt'.format(layer),
                    './models/ResNet-{}-model.caffemodel'.format(layer), caffe.TEST)
    ...
    serializers.save_hdf5('models/{}.model'.format(args.model), model)
    print '\nfinish.'
